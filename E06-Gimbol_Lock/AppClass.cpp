...
void Application::Display(void)
{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::X))
		//m_m4Model = glm::rotate(m_m4Model, m_v3Rotation.x, vector3(1.0f, 0.0f, 0.0f));
		m_qOrientation = m_qOrientation * glm::angleAxis(1.0f, vector3(1.0f,0.0f,0.0f));
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
		//m_m4Model = glm::rotate(m_m4Model, m_v3Rotation.y, vector3(0.0f, 1.0f, 0.0f));
		m_qOrientation = m_qOrientation * glm::angleAxis(1.0f, vector3(0.0f,1.0f,0.0f));
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
		//m_m4Model = glm::rotate(m_m4Model, m_v3Rotation.z, vector3(0.0f, 0.0f, 1.0f));
		m_qOrientation = m_qOrientation * glm::angleAxis(1.0f, vector3(0.0f,0.0f,1.0f));
