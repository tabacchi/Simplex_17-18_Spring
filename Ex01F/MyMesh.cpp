...
void MyMesh::GenerateCone(float a_fRadius, float a_fHeight, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	vector3 point0(a_fHeight , 0, 0); //top
	vector3 point1(0, 0, 0); //bottom
	vector3 point2(0, cos(radions), sin(radions)); //start
	...
	for (int i = 0; i < a_nSubdivisions - 1; i++)
	{
		pos += degrees;
		radions = (PI / 180)*pos;
		vector3 point3(0, cos(radions), sin(radions));
		AddTri(point3, lastvector, point0);
		lastvector = point3;

	}
	AddTri(point2, lastvector, point0);
	...
	for (int i = 0; i < a_nSubdivisions - 1; i++)
	{
		...
		radions = (PI / 180)*pos;
		vector3 point3(0, cos(radions), sin(radions));
		AddTri(lastvector, point3, point1);
		lastvector = point3;

	}
	AddTri(lastvector, point2, point1);
